...
You can find the ABI file for the contract in the `abi` directory of this repository.
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Aggregator.DexInfo",
          "name": "",
          "type": "tuple"
        }
      ],
